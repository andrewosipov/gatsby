export default function () {
    ...
    (function () {
        ...
        null == window.__sharethis__ && (window.__sharethis__ = {
            ...
            var o, n, r, s;
            for (null == e && (e = ["all"]), null == t && (t = "0.2s"), s = [], o = 0, n = e.length; o < n; o++) r = e[o], s.push(r + " " + t + " ease-in");
            ...
            var n, r, s, i;
            for (n = (e.className || "").split(" "), "string" == typeof o && (o = [o]), r = 0, s = o.length; r < s; r++) i = o[r], null != i && t.call(n, i) < 0 && n.push(i);
            return e.className = n.join(" ")
        }, e.addEventListener = function (e, t, o) {
            if (e && t && o) return e.addEventListener ? e.addEventListener(t, o, !1) : e.attachEvent ? e.attachEvent("on" + t, o) : e["on" + t] = o
            ...
            var t, o;
            return t = document.getElementsByTagName("head")[0], o = document.createElement("style"), o.setAttribute("type", "text/css"), o.styleSheet ? o.styleSheet.cssText = e : o.appendChild(document.createTextNode(e)), t.appendChild(o)
        }, e.emit = function (t, o) {
            var n, r, s, i, a, l;
            for (a = (null != (i = e.handlers) ? i[t] : void 0) || [], l = [], r = 0, s = a.length; r < s; r++) n = a[r], l.push(n(o));
            return l
        }, e.formatNumber = function (e) {
            return e > 1e6 ? Math.round(10 * (e / 1e6)) / 10 + "m" : e > 1e3 ? Math.round(10 * (e / 1e3)) / 10 + "k" : "" + e
        }, e.getCookie = function (e) {
            var t, o;
            return o = "; " + document.cookie, t = o.split("; " + e + "="), 2 === t.length ? t.pop().split(";").shift() : null
        }, e.getDescription = function () {
            var e, t, o, n, r, s, i, a, l;
            for (i = ["property", "name"], o = 0, r = i.length; o < r; o++)
                for (t = i[o], a = ["og:description", "twitter:description", "description", "Description"], n = 0, s = a.length; n < s; n++)
                    if (l = a[n], e = document.querySelector("meta[" + t + "='" + l + "']")) return e.content;
            return ""
        }, e.getImage = function () {
            var e, t, o, n, r, s, i, a, l;
            for (i = ["property", "name"], o = 0, r = i.length; o < r; o++)
                for (t = i[o], a = ["og:image", "twitter:image"], n = 0, s = a.length; n < s; n++)
                    if (l = a[n], e = document.querySelector("meta[" + t + "='" + l + "']")) return e.content;
            return ""
        }, e.getScrollbarWidth = function () {
            var e, t, o;
            return t = document.createElement("div"), t.style.visibility = "hidden", t.style.width = "100px", t.style.msOverflowStyle = "scrollbar", t.style.overflow = "scroll", document.body.appendChild(t), e = document.createElement("div"), e.style.width = "100%", t.appendChild(e), o = t.offsetWidth - e.offsetWidth, t.parentNode.removeChild(t), o
        }, e.getScrollDepth = function () {
            var t, o, n, r, s, i;
            return n = document.documentElement, t = document.body, o = Math.max.apply(Math, [t.scrollHeight || 0, t.offsetHeight || 0, n.clientHeight || 0, n.scrollHeight || 0, n.offsetHeight || 0]), i = e.getWindowSize().height, r = window.pageYOffset || (n || t.parentNode || t).scrollTop, s = Math.floor(100 * (i + r) / o)
            ...
            var e, t, o, n, r, s, i, a, l;
            for (i = ["property", "name"], o = 0, r = i.length; o < r; o++)
                for (t = i[o], a = ["og:title", "twitter:title"], n = 0, s = a.length; n < s; n++)
                    if (l = a[n], e = document.querySelector("meta[" + t + "='" + l + "']")) return e.content;
            return document.title
        }, e.getWindowSize = function () {
            var e, t, o, n;
            return e = document.body, t = document.documentElement, o = window.innerHeight, n = window.innerWidth, {
            ...
            var o;
            return null == t && (t = e.href), o = document.createElement("a"), o.setAttribute("href", t), o.hostname
        }, e.img = function (e) {
            if (e) return '<img src="' + e + '" />'
        }, e.incLocalStorageShares = function (t, o) {
            var n, r, s, i, a, l, u, c, h;
            if (n = e.storage.get("st_shares_" + o)) return r = (null != (s = n[t]) ? s.value : void 0) + 1 || 0, h = (null != (i = n.total) ? i.value : void 0) + 1 || 0, null != (a = n[t]) && (a.value = r), null != (l = n[t]) && (l.label = e.formatNumber(r)), null != (u = n.total) && (u.value = h), null != (c = n.total) && (c.label = e.formatNumber(h)), n.update_time = Math.round(new Date / 1e3), e.storage.set("st_shares_" + o, n)
        }, e.inc = function (t) {
            var o;
            return o = e.parseNumber(t.innerText), t.innerText = e.formatNumber(o + 1), e.addClass(t, "st-grow"), setTimeout(function () {
            ...
            var t, o;
            return t = document.createElement("script"), t.async = 1, t.src = e, o = document.getElementsByTagName("script")[0], o.parentNode.insertBefore(t, o)
        }, e.loader = {}, e.load = function (t, o) {
            var n;
            return "function" == typeof(n = e.loader)[t] ? n[t](o) : void 0
        }, e.load_counts_cache = {}, e.loadCounts = function (t, o) {
            var n, r, s, i, a, l, u;
            return o || (a = [{}, t], t = a[0], o = a[1]), null == t.facebook && (t.facebook = !1), null == t.type && (t.type = "shares"), null == t.url && (t.url = e.href), null == t.use_native_counts && (t.use_native_counts = !0), i = "count:" + JSON.stringify(t), null == (n = e.load_counts_cache)[i] && (n[i] = {
                callbacks: [o],
                response: null,
                status: "init"
            }), "complete" === (null != (l = e.load_counts_cache[i]) ? l.status : void 0) ? o(e.load_counts_cache[i].response) : "in-progress" === (null != (u = e.load_counts_cache[i]) ? u.status : void 0) ? e.load_counts_cache[i].callbacks.push(o) : (s = "cb" + e.uid(), r = !1, e[s] = function (o) {
                var n, s, a, l, u, c, h, d, p, m, f, g, v, w, b, _;
                if (null == o && (o = {}), r = !0, a = {}, "reactions" === t.type)
                    for (m in e.REACTIONS) _ = (null != (f = o.reactions) ? f[m] : void 0) || 0, a[m] = {
                        value: _,
                        label: e.formatNumber(_)
                    };
                if ("shares" === t.type) {
                    for (g = e.networks, l = 0, c = g.length; l < c; l++) p = g[l], _ = ((null != (v = o.clicks) ? v[p] : void 0) || 0) + ((null != (w = o.shares) ? w[p] : void 0) || 0), a[p] = {
                        value: _,
                        label: e.formatNumber(_)
                    };
                    a.total = {
                        value: o.total,
                        label: e.formatNumber(o.total)
                    }
                }
                if (a.update_time = o.update_time, d = e.storage.get("st_shares_" + t.url), o.update_time < (null != d ? d.update_time : void 0) && (a = d), t.facebook && t.use_native_counts) return null == a.facebook && (a.facebook = {
                    value: 0
                }), null == (n = a.facebook).value && (n.value = 0), e.loadFacebookShareCount(t.url, function (o) {
                    var n, r, s, l, u;
                    for (_ = Math.max(o, a.facebook.value), u = a.total.value - a.facebook.value + _, a.facebook = {
                        value: _,
                        label: e.formatNumber(_)
                    }, a.total = {
                        value: u,
                        label: e.formatNumber(u)
                    }, e.load_counts_cache[i].response = a, e.load_counts_cache[i].status = "complete", e.storage.set("st_shares_" + t.url, a), l = e.load_counts_cache[i].callbacks, r = 0, s = l.length; r < s; r++) (n = l[r])(a);
            ...
            var n;
            return n = "cb" + e.uid(), e[n] = function (e) {
                var t;
                return o(JSON.parse((null != e && null != (t = e.share) ? t.share_count : void 0) || 0))
            }, e.js(e.protocol + "://graph.facebook.com?" + e.qs({
                id: t,
                callback: "window.__sharethis__." + n
            }))
        }, e.logGoogleAnalyticsEvent = function (e, t, o) {
            var n, r;
            return r = window.ga, n = window._gaq, r ? r("send", "event", e, t, o) : n ? n.push(["_trackEvent", e, t, o]) : void 0
        }, e.newElement = function (t) {
            var o, n;
            return void 0 === t && (t = document.body), o = document.createElement("div"), n = "st-el-" + e.uid(), o.setAttribute("id", n), t && t.appendChild(o), {
                $el: o,
                id: n
            }
        }, e.on = function (t, o) {
            var n;
            return null == e.handlers && (e.handlers = []), null == (n = e.handlers)[t] && (n[t] = []), e.handlers[t].push(o)
        }, e.open = function (t) {
            var o, n, r, s;
            return e.mobile ? window.open(t, "_blank") : t.indexOf("mailto:") > -1 ? document.location = t : (r = e.getWindowSize().height, s = e.getWindowSize().width, o = Math.min(600, .6 * r), n = Math.min(800, .8 * s), window.open(t, "", ["height=" + o, "left=" + (s - n) / 2, "top=" + (r - o) / 2, "width=" + n, "status=1", "toolbar=0"].join(",")))
            ...
            var o, n;
            return null == t && (t = window), n = e.getBoundingClientRect(), t === window ? {
            ...
            return function () {
                var n;
                n = [];
                for (t in e) o = e[t], null != o && n.push(t + "=" + encodeURIComponent(o));
                return n
            }().join("&")
        }, e.react = function (t) {
            var o, n, r;
            return o = t.reaction, r = t.url, null == r && (r = e.href), n = e.getTitle(), e.logGoogleAnalyticsEvent("ShareThis", o, r), e.send(e.protocol + "://l.sharethis.com/reaction", {
                type: o,
                url: r
            ...
            if (e && t && o) return e.removeEventListener ? e.removeEventListener(t, o, !1) : e.detachEvent ? e.detachEvent("on" + t, o) : e["on" + t] = null
        }, e.send = function (t, o, n) {
            var r;
            return o && (t = t + "?" + e.qs(o)), r = new Image(1, 1), r.src = t, r.onload = function () {
            ...
            var n, r;
            return o ? (n = new Date, n.setTime(n.getTime() + 24 * o * 60 * 60 * 1e3), r = "; expires=" + n.toGMTString()) : r = "", document.cookie = e + "=" + t + r + "; path=/"
        }, e.share = function (t) {
            var o, n, r, s, i, a, l, u, c, h, d, p, m, f, g, v;
            if (null == t && (t = {}), o = t.count_url, r = t.email_subject, p = t.share_url, f = t.url, n = t.description, i = t.image, u = t.message, c = t.network, m = t.title, g = t.username, o = o || f || e.href, null == n && (n = e.getDescription()), null == i && (i = e.getImage()), p = p || f || e.href, null == m && (m = e.getTitle()), null == f && (f = o), "sharethis" === c) return e.load("share-all", {
                count_url: o,
                description: n,
                image: i,
                share_url: p,
            ...
            if (e.incLocalStorageShares(c, o), e.logGoogleAnalyticsEvent("ShareThis", c, o), e.send(e.protocol + "://l.sharethis.com/log?" + e.qs({
                    destinations: c,
                    event: "share",
                    product: e.product,
                    publisher: e.property,
            ...
            return "print" === c ? (e.emit("print", {
                ...
                url: f,
                username: g
            }), window.print()) : (s = document.location.hostname, h = e.product, l = /iPad|iPhone|iPod/.test(navigator.userAgent), a = /Android/i.test(navigator.userAgent), d = {
            ...
            return function (t) {
                var o, n, r;
                return null == t && (t = {}), o = t.follow_url, n = t.network, r = t.url, null == r && (r = e.href), e.send(e.protocol + "://l.sharethis.com/log?" + e.qs({
                    destinations: n,
                    event: "follow",
                    followUrl: o,
                    product: e.product,
            ...
            set: function (t, o) {
                return e.hasLocalStorage ? localStorage.setItem(t, JSON.stringify(o)) : e.hasCookies ? e.setCookie(t, o) : e.set(t, val)
            }
        }, e.svg = function (e, t) {
            var o;
            return null == t && (t = 40), "string" == typeof e && (e = [e]), '<svg fill="#fff" preserveAspectRatio="xMidYMid meet" height="1em" width="1em" viewBox="0 0 ' + t + " " + t + '">\n  <g>\n    ' + function () {
                var t, n, r;
                for (r = [], t = 0, n = e.length; t < n; t++) o = e[t], r.push("<path d='" + o + "'></path>");
                return r
            }().join("") + "\n  </g>\n</svg>"
    ...
    (function () {
        var t;
        t = window.__sharethis__, t.domains = {
    ...
    (function () {
        ...
        s = window.__sharethis__.svg, C = window.__sharethis__.img, t = /MSIE 8.0/.test(navigator.userAgent), window.__sharethis__.ICONS = {
            ...
            stumbleupon: C("https://s3.amazonaws.com/sharethis-socialab-prod/ie8buttons/stumbleupon.png"),
    ...
    (function () {
        var e;
        e = window.__sharethis__, e.networks = ["blogger", "delicious", "digg", "email", "facebook", "flipboard", "googleplus", "linkedin", "livejournal", "mailru", "meneame", "messenger", "odnoklassniki", "pinterest", "print", "reddit", "sharethis", "sms", "stumbleupon", "tumblr", "twitter", "vk", "wechat", "weibo", "whatsapp", "xing"]
    }).call(this);

    (function () {
        window.__sharethis__.PRODUCTS = ["custom-share-buttons", "ecommerce", "email-list-builder", "ga", "genesis-media", "google-analytics", "image-share-buttons", "inline-follow-buttons", "inline-reaction-buttons", "inline-share-buttons", "inline-share-buttons-wp", "privy-share-buttons", "promo-bar", "social-ab", "sop", "sop-wordpress-plugin", "sticky-share-buttons", "sticky-share-buttons-wp", "top-content", "unknown", "viral-notifications"]
    }).call(this);
    ...
    __stdos__.cookie = {
        setCookie: function (t, e, o) {
            ...
            if (a || n) {
                ...
                r.name = t, r.src = "javascript:false", r.style.display = "none", d.appendChild(r), i.action = ("https:" == document.location.protocol ? "https://sharethis.com/" : "http://sharethis.com/") + "account/setCookie.php", i.method = "POST";
        ...
        setOptout: function () {
            opt_out = __stdos__.cookie.getCookie("st_optout"), __stdos__.data.set("st_optout", opt_out, "pageInfo")
        },
        ...
        resetPageData: function () {
            __stdos__.data.pageInfo.fpc = "ERROR", __stdos__.data.pageInfo.sessionID = "ERROR", __stdos__.data.pageInfo.hostname = "ERROR", __stdos__.data.pageInfo.location = "ERROR", __stdos__.data.pageInfo.product = "DOS2", __stdos__.data.pageInfo.url = "ERROR", __stdos__.data.pageInfo.sharURL = "", __stdos__.data.pageInfo.buttonType = "ERROR", __stdos__.data.pageInfo.destination = "ERROR", __stdos__.data.pageInfo.source = "ERROR"
        },
        init: function () {
        ...
        setRefDomain: function (t) {
            if (0 != t.length) {
                ...
                e.length > 0 && (t = "undefined" != typeof e[0] ? e[0] : t, refQuery = "undefined" != typeof e[1] ? e[1] : "", __stdos__.data.set("refQuery", refQuery, "pageInfo"), __stdos__.data.set("refDomain", t, "pageInfo"))
            }
        },
        set: function (t, e, o) {
        ...
        log: function (t, e, o) {
            __stdos__.data.set("ts" + (new Date).getTime(), "", "pageInfo"), e = __stdos__.logger.loggerUrl;
            ...
            try {
                ...
                n.open("GET", a, !0), n.withCredentials = !0, n.onreadystatechange = function () {
                    if (this.readyState == this.HEADERS_RECEIVED) {
                        var t = n.getResponseHeader("stid");
                        __stdos__.data.set("stid", t, "pageInfo"), o ? o() : null
                    }
                }, n.send()
            } catch (t) {
                var s = new Image(1, 1);
        ...
        function () {
            ...
            "genesis-media" == t.product ? t.send(t.protocol + "://l.sharethis.com/gmedia", {
                url: t.href
            }) : e || __stdos__.onscriptload || document.URL.indexOf("edge.sharethis.com") != -1 || (__stdos__.data.init(), __stdos__.data.set("publisher", t.property, "pageInfo"), __stdos__.data.set("product", t.product, "pageInfo"), __stdos__.onscriptload = !0, __stdos__.logger.log("pview"))
        }();
    ...
    (function () {
        ...
        t = window.__sharethis__, t.loader["inline-follow-buttons"] = function (t) {
            ...
            for (a && (null != o ? o.length : void 0) > 0 && "right" === s && (b += "<div class='st-" + s + "'>\n  <span>" + t.capitalize(o) + "</span>\n</div>"), n.innerHTML = b, e = n.querySelectorAll(".st-btn"), C = function () {
                var t, i, l, o, s, d, p;
                for (l = n.offsetWidth, i = function () {
                    var n, t, i, l;
                    for (l = a ? 70 : 0, t = 0, i = e.length; t < i; t++) n = e[t], "none" !== n.style.display && (l += "justified" === r ? 160 : n.offsetWidth + z);
                    return l
                }, o = 0, d = e.length; o < d; o++) t = e[o], t.style.display = "inline-block";
                for (p = [], x = s = e.length - 1; s >= 0; x = s += -1) t = e[x], i() > l ? p.push(t.style.display = "none") : p.push(void 0);
                return p
            }, t.addEventListener(window, "resize", C), h = function (i) {
                return t.addEventListener(i, "click", function () {
                    var l;
                    return A = i.getAttribute("data-network"), l = t.domains[A] + (S[A] || ""), "youtube" === A && S[A] && (l += "?sub_confirmation=1"), "tumblr" === A && S[A] && (l = t.domains[A].replace("www", S[A])), t.follow({
                        follow_url: l,
                        network: A,
                        url: E || n.getAttribute("data-url")
                    })
                })
            }, y = 0, _ = e.length; y < _; y++) l = e[y], h(l);
            return C(), g && t.addClass(n, "st-animated"), g && t.removeClass(n, "st-hidden"), "function" == typeof R && R(), {
                $buttons: e,
                $el: n,
                id: w,
                resize: C
    ...
    (function () {
        ...
        n = window.__sharethis__, n.loader["inline-share-buttons"] = function (e) {
            ...
            for (t.innerHTML = v, l = t.querySelectorAll(".st-btn"), a = t.querySelector(".st-total"), o = t.querySelector(".st-total .st-label"), H = function () {
                ...
                return p
            }, n.addEventListener(window, "resize", H), g = function (e) {
            ...
            }, k = 0, z = l.length; k < z; k++) s = l[k], g(s);
            return $ || "counts" === S ? n.loadCounts({
                facebook: e.call(M, "facebook") >= 0,
                url: G || t.getAttribute("data-url"),
                use_native_counts: J
            }, function (e) {
                var i, r, d, u, h, p, c;
                if ($ && ((null != (d = e.total) ? d.value : void 0) > R ? (o.innerHTML = (null != (u = e.total) ? u.label : void 0) || "", n.removeClass(a, "st-hidden")) : n.addClass(a, "st-hidden")), "counts" === S)
                    for (i = 0, r = l.length; i < r; i++) s = l[i], N = s.getAttribute("data-network"), h = e[N] || {}, C = h.label, c = h.value, C && c > R ? (null != (p = s.querySelector(".st-label")) && (p.innerHTML = C), n.removeClass(s, "st-hide-label")) : n.addClass(s, "st-hide-label");
                return H(), b && n.addClass(t, "st-animated"), b && n.removeClass(t, "st-hidden"), "function" == typeof q ? q() : void 0
            }) : (H(), b && n.addClass(t, "st-animated"), b && n.removeClass(t, "st-hidden"), "function" == typeof q && q()), {
                $buttons: l,
                $el: t,
                id: y,
                resize: H
    ...
    (function () {
        ...
        t = window.__sharethis__, t.loader["sticky-share-buttons"] = function (e) {
            ...
            if (null == e && (e = {}), e.enabled)
                if (e.id) {
                    ...
                    if (!e.container) {
                        ...
                        for (p = [], s = 0, a = l.length; s < a; s++) i = l[s], p.push(n(i, e));
                        return p
                    }
            ...
            var l, s, o, a, r, d, p, h, u, g, c, b, f, v, m, x, w, y, k, _, A, I, S, T, N, O, C, R, z, L, E, q, B, j, M,
                D, H, F, W, $, U, X, Y, G, J, K, P, Q, V, Z, nn, tn, en, ln, sn;
            if (H = i.onLoad, d = i.alignment, g = i.container, v = i.font_size, m = i.hide_desktop, F = i.padding, W = i.radius, Q = i.size, Z = i.spacing, k = i.id, O = i.labels, C = i.language, E = i.min_count, D = i.networks, K = i.show_toggle, P = i.show_total, q = i.mobile_breakpoint, G = i.show_mobile, V = i.slide_in, tn = i.top, ln = i.use_native_counts, J = i.show_mobile_buttons, en = i.url, nn = i.title, _ = i.image, b = i.description, sn = i.username, p = "left" === d ? "right" : "left", null == d && (d = "left"), null == m && (m = !1), null == O && (O = "counts"), null == C && (C = "en"), null == E && (E = 0), null == q && (q = 0), null == D && (D = ["facebook", "twitter", "pinterest", "email", "sharethis", "sms"]), null == F && (F = 12), null == W && (W = 0), null == G && (G = !1), null == K && (K = !0), null == P && (P = !1), null == Q && (Q = 48), null == V && (V = !0), null == tn && (tn = 100), null == ln && (ln = !0), null == J && (J = t.mobile), null == k && (k = "st-" + t.uid()), n.setAttribute("id", k), Y = "right" === d ? t.getScrollbarWidth() : 0, Y = 0, t.addClass(n, ["st-sticky-share-buttons", "st-" + d, K ? "st-toggleable" : void 0, "counts" === O || "cta" === O ? "st-has-labels" : void 0, P ? "st-show-total" : void 0, V ? "st-hidden" : void 0]), u = "#" + k + " {\n  " + t.FONT_FAMILY + ";\n  " + t.TRANSITION() + "\n  backface-visibility: hidden;\n  display: " + (m ? "none" : "block") + ";\n  position: fixed;\n  opacity: 1;\n  text-align: left;\n  top: " + t.px(tn) + ";\n  z-index: 94034;\n}\n#" + k + ".st-" + d + " {\n  " + d + ": " + t.px(Y) + ";\n}\n#" + k + ".st-hidden.st-" + d + " {\n  " + d + ": -" + t.px(Q) + ";\n}\n#" + k + ".st-hidden {\n  width: " + t.px(2 * Q) + ";\n}\n#" + k + " > div {\n  clear: " + d + ";\n  float: " + d + ";\n}\n#" + k + " .st-btn {\n  " + t.BORDER_BOX + "\n  " + t.TRANSITION() + "\n  cursor: pointer;\n  display: inline-block;\n  font-size: " + t.px(v) + ";\n  height: " + t.px(Q) + ";\n  line-height: " + t.px(Q / 2) + ";\n  margin-bottom: " + (Z ? t.px(Z) : 0) + ";\n  opacity: 1;\n  overflow: hidden;\n  padding: " + t.px(F) + ";\n  position: relative;\n  text-align: left;\n  top: 0;\n  vertical-align: top;\n  white-space: nowrap;\n  width: " + t.px(Q) + ";\n}\n#" + k + " .st-btn.st-first {\n  border-top-" + p + "-radius: " + t.px(W) + ";\n}\n#" + k + " .st-btn.st-last {\n  border-bottom-" + p + "-radius: " + t.px(W) + ";\n}\n#" + k + " .st-btn > svg {\n  " + t.TRANSITION() + "\n  height: " + t.px(Q / 2) + ";\n  margin-left: 0;\n  vertical-align: top;\n  width: " + t.px(Q / 2) + ";\n}\n#" + k + " .st-btn > img {\n  " + t.TRANSITION() + "\n  height: " + t.px(Q / 2) + ";\n  margin-left: 0;\n  vertical-align: top;\n  width: " + t.px(Q / 2) + ";\n}\n#" + k + " .st-btn > span {\n  " + t.TRANSITION() + "\n  color: #fff;\n  display: inline-block;\n  font-weight: 500;\n  left: -35px;\n  letter-spacing: 0.5px;\n  opacity: 0;\n  padding: 0 6px;\n  position: relative;\n  vertical-align: top;\n  filter: alpha(opacity=0);\n}\n#" + k + " .st-btn.st-hide-label > span {\n  display: none !important;\n}\n#" + k + " .st-total {\n  " + t.TRANSITION() + "\n  background: #fff;\n  color: #555;\n  display: inline-block;\n  font-weight: 500;\n  line-height: " + t.px(.375 * Q) + ";\n  margin-right: 0;\n  min-height: 34px;\n  max-width: 80px;\n  opacity: 1;\n  padding: 4px 0;\n  text-align: center;\n  width: " + t.px(Q) + ";\n}\n#" + k + " .st-total.st-hidden {\n  display: none;\n}\n#" + k + " .st-total > span {\n  display: block;\n  font-size: " + t.px(.38 * Q) + ";\n  line-height: " + t.px(.45 * Q) + ";\n  padding: 0;\n}\n#" + k + " .st-total > span.st-shares {\n  font-size: " + t.px(.23 * Q) + ";\n  line-height: " + t.px(.23 * Q) + ";\n}\n#" + k + " .st-toggle {\n  " + d + ": -" + t.px(Q + Y) + ";\n  " + t.TRANSITION() + "\n  background: #ccc;\n  border-bottom-" + p + "-radius: " + t.px(W) + ";\n  color: white;\n  cursor: pointer;\n  font-size: " + t.px(.5 * Q) + ";\n  line-height: " + t.px(.5 * Q) + ";\n  position: relative;\n  text-align: center;\n  width: " + t.px(Q) + ";\n}\n#" + k + ".st-hidden .st-toggle {\n  border-top-" + p + "-radius: " + t.px(W) + ";\n}\n#" + k + ".st-" + d + " .st-toggle .st-" + d + " {\n  display: inline-block;\n}\n#" + k + ".st-" + d + ".st-hidden .st-toggle .st-" + d + " {\n  display: none;\n}\n#" + k + ".st-" + d + " .st-toggle .st-" + p + " {\n  display: none;\n}\n#" + k + ".st-" + d + ".st-hidden .st-toggle .st-" + p + " {\n  display: inline-block;\n}", B = "#" + k + " {\n  bottom: 0;\n  display: " + (G ? "flex" : "none") + ";\n  left: 0;\n  right: 0;\n  top: auto;\n  width: 100%;\n}\n#" + k + ".st-hidden {\n  bottom: -" + t.px(Q) + ";\n  width: 100%;\n}\n#" + k + ".st-hidden.st-left {\n  left: 0;\n}\n#" + k + ".st-hidden.st-right {\n  right: 0;\n}\n#" + k + " > div {\n  -moz-flex: 1;\n  -ms-flex: 1;\n  -webkit-flex: 1;\n  clear: none;\n  flex: 1;\n  float: none;\n}\n#" + k + " .st-total {\n  background: #fff;\n  padding: 6px 8px;\n}\n#" + k + " .st-btn {\n  " + t.BORDER_RADIUS("0 !important") + "\n  text-align: center;\n  width: auto;\n}\n#" + k + " .st-btn > span {\n  display: none;\n}\n#" + k + " .st-toggle {\n  display: none;\n}", G && !document.body.style.paddingBottom && (B += "body { padding-bottom: 48px; }"), X = "@media (max-width: " + t.px(q) + ") {\n  " + B + "\n}", x = "#" + k + ":hover .st-toggle {\n  " + d + ": 0;\n}\n#" + k + ".st-hidden:hover .st-toggle {\n  " + d + ": " + t.px(Q) + ";\n}\n#" + k + ".st-toggleable:hover .st-btn.st-last {\n  border-bottom-" + p + "-radius: 0;\n}\n#" + k + ".st-toggleable:hover .st-btn.st-last:hover {\n  border-bottom-" + p + "-radius: " + t.px(W) + ";\n}\n#" + k + " .st-btn:hover {\n  border-bottom-" + p + "-radius: " + t.px(W) + ";\n  border-top-" + p + "-radius: " + t.px(W) + ";\n}\n#" + k + ".st-has-labels .st-btn:hover {\n  width: " + t.px(2.5 * Q) + ";\n}\n#" + k + ":not(.st-has-labels) .st-btn:hover {\n  width: " + t.px(1.3 * Q) + ";\n}\n#" + k + " .st-btn.st-hide-label:hover {\n  width: " + t.px(1.3 * Q) + ";\n}\n#" + k + " .st-btn:hover > svg {\n  margin-left: 5px;\n}\n#" + k + " .st-btn:hover > img {\n  margin-left: 5px;\n}\n#" + k + " .st-btn:hover > span {\n  opacity: 1;\n  display: inline-block;\n  left: 0;\n  filter: alpha(opacity=100);\n}\n@media (max-width: " + t.px(q) + ") {\n  #" + k + " .st-btn:hover > svg {\n    margin-left: 0;\n  }\n  #" + k + " .st-btn:hover > span {\n    display: none;\n  }\n}", M = function () {
                    var n, e, i;
                    for (i = [], n = 0, e = D.length; n < e; n++) j = D[n], i.push("#" + k + " .st-btn[data-network='" + j + "'] {\n  background-color: " + t.COLORS[j] + ";\n}");
                    return i
                }().join("\n"), c = u, t.mobile || (c += x), t.mobile || (c += X), t.mobile && (c += B), c += M, t.css(c), !J)
                for ($ = ["sms"], y = 0, R = $.length; y < R; y++) j = $[y], A = D.indexOf(j), A > -1 && D.splice(A, 1);
            for (w = "", P && (w += "<div class='st-total st-hidden'>\n  <span class='st-label'></span>\n  <span class='st-shares'>\n    " + t.capitalize(t.i18n.shares[C]) + "\n  </span>\n</div>"), A = I = 0, z = D.length; I < z; A = ++I) j = D[A], h = ["st-btn"], 0 === A && h.push("st-first"), A === D.length - 1 && h.push("st-last"), T = t.getShareLabel(j, C), "cta" !== O && (T = ""), N = "<span class='st-label'>" + T + "</span>", w += "<div class='" + h.join(" ") + "' data-network='" + j + "'>\n  " + t.ICONS[j] + "\n  " + ("counts" === O || "cta" === O ? N : "") + "\n</div>";
            for (K && (w += '<div class="st-toggle">\n  <div class="st-left">\n    ' + t.ICONS.arrow_left + '\n  </div>\n  <div class="st-right">\n    ' + t.ICONS.arrow_right + "\n  </div>\n</div>"), n.innerHTML = w, s = n.querySelectorAll(".st-btn"), o = n.querySelector(".st-toggle"), a = n.querySelector(".st-total"), r = n.querySelector(".st-total .st-label"), t.addEventListener(o, "click", function () {
                return t.toggleClass(n, "st-hidden")
            }), U = function () {
                var n, i, l, o, a, r, d, p;
                for (r = 100, (t.mobile || window.innerWidth < q) && (r = 6), P && r--, e.call(D, "sharethis") >= 0 && r--, e.call(D, "sms") >= 0 && r--, e.call(D, "whatsapp") >= 0 && r--, e.call(D, "messenger") >= 0 && r--, e.call(D, "wechat") >= 0 && r--, i = 0, o = s.length; i < o; i++) n = s[i], n.style.display = "inline-block";
                for (p = [], A = l = 0, a = s.length; l < a; A = ++l) n = s[A], "sharethis" !== (d = n.getAttribute("data-network")) && "sms" !== d && "messenger" !== d && "whatsapp" !== d && "wechat" !== d && (r-- > 0 || p.push(n.style.display = "none"));
                return p
            }, t.addEventListener(window, "resize", U), f = function (e) {
                return t.addEventListener(e, "click", function () {
                    return t.share({
                        ...
                        title: nn || (null != n ? n.getAttribute("data-title") : void 0),
                        url: en || (null != n ? n.getAttribute("data-url") : void 0),
                        username: sn || (null != n ? n.getAttribute("data-username") : void 0)
                    })
                })
            }, S = 0, L = s.length; S < L; S++) l = s[S], f(l);
            return P || "counts" === O ? t.loadCounts({
                facebook: e.call(D, "facebook") >= 0,
                url: en || (null != n ? n.getAttribute("data-url") : void 0),
                use_native_counts: ln
            }, function (e) {
                var i, o, d, p, h, u;
                if (P && ((null != (d = e.total) ? d.value : void 0) > E ? (r.innerHTML = e.total.label, t.removeClass(a, "st-hidden")) : t.addClass(a, "st-hidden")), "counts" === O)
                    for (i = 0, o = s.length; i < o; i++) l = s[i], j = l.getAttribute("data-network"), p = e[j] || {}, T = p.label, u = p.value, T && u > E ? (null != (h = l.querySelector(".st-label")) && (h.innerHTML = T), t.removeClass(l, "st-hide-label")) : t.addClass(l, "st-hide-label");
    ...
    (function () {
        window.__sharethis__.md5 = "dc3345ee9b6ac7b93500fda61e41c402";
    })();
